...
// log some stuff
console.log(` [Hey I'm Worker Pal] Write-up on how ${workerData} wants to chill with the big boys`);
 ...
 */
 ...
 icmp.send(`${target_ip_addr_to_ping}`, "Hey, I'm pokus!")
 .then(obj => {
