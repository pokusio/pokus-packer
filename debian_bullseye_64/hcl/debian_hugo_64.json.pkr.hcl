...
variable "boot_command_env_addon" {
  ...
  default = "packer_fileserver_ip={{ .HTTPIP }} packer_fileserver_port={{ .HTTPPort }} hostname=packerpokus.io golang_version=1.18.3 hugo_version=0.100.2"
}
...
source "virtualbox-iso" "pokus_debian_64" {
...
build {
  sources = ["source.virtualbox-iso.pokus_debian_64"]
